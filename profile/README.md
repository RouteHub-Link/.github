...
## What is Route Hub?
A straightforward CMS for link forwarding management.
...
## Current Projects
- **RouteHub Dashboard:** [RouteHub.Client.Hub](https://github.com/RouteHub-Link/RouteHub.Service.Dashboard) An deployable management application developed as SSR.
...
- **The Dashboard:** An Dashboard consumes GraphQL API. (Will be worked on after the sponsorship)
